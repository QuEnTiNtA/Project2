...
def get_transform(train):
    """implement combined random transformations on training set, including normalizing, flipping, rotating, random cropping, gaussian blurring. For validation set, 
    """
    if train:
