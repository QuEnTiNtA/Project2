...
As we accidentally lost the best checkpoint file with , here we only provide the second best saved checkpoint (91.3%). It can be accessed in the google drive:
