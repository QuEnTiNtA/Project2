...
def get_transform(train):
    """implement combined random transformations on training set, including normalizing, 
    flipping, rotating, random cropping, gaussian blurring. For testing set, only normalization is applied. 
    """
    if train:
