...
As we accidentally lost the best checkpoint, which was able to reach the F1 score of 91.4% in the AICROWD  here we only provide the second best saved checkpoint (91.3%). It can be accessed in the google drive:
